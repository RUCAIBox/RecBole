...
In the lastest release, our library includes 75 recommendation algorithms `[Model List]`_, covering four major categories:
...
- Comprehensive benchmark models and datasets
    We implement 75 commonly used recommendation algorithms, and provide the formatted copies of 28 recommendation datasets.
...
Nov. 2020 ~ Now          v0.1.2 ~ v1.0.0   `Yushuo Chen <https://github.com/https://github.com/chenyushuo>`_, `Xingyu Pan <https://github.com/2017pxy>`_
======================   ===============   =============================================
