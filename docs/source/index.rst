...
In the lastest release, our library includes 74 recommendation algorithms `[Model List]`_, covering four major categories:
...
- Comprehensive benchmark models and datasets
    We implement 74 commonly used recommendation algorithms, and provide the formatted copies of 28 recommendation datasets.
