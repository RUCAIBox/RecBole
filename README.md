...
Our library includes 75 recommendation algorithms, covering four major categories:
...
+ **Comprehensive benchmark models and datasets.** We implement 75 commonly used recommendation algorithms, and provide
