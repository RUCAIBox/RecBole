...
- **Logging Result**:
  ...
  ```yaml
  100%|██████████| 9/9 [42:50<00:00, 285.60s/trial, best loss: -0.0318]
  best params:  {'dropout_prob': 0.1, 'learning_rate': 0.003}
  best result: 
  {'model': 'NPE', 'best_valid_score': 0.0318, 'valid_score_bigger': True, 'best_valid_result': OrderedDict([('recall@10', 0.0723), ('mrr@10', 0.0198), ('ndcg@10', 0.0318), ('hit@10', 0.0723), ('precision@10', 0.0072)]), 'test_result': OrderedDict([('recall@10', 0.0633), ('mrr@10', 0.018), ('ndcg@10', 0.0284), ('hit@10', 0.0633), ('precision@10', 0.0063)])}
  ```
