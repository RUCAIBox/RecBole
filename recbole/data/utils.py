...
def dataloader_construct(
    ...
    model_type = config['MODEL_TYPE']
    logger = getLogger()
    logger.info(f'\033[1;35mBuild\033[0m \033[1;33m[{model_type}]\033[0m DataLoader for \033[1;33m[{name}]\033[0m with format \033[1;33m[{dl_format}]\033[0m')
    logger.info(eval_setting)
    logger.info(f'\033[0;36mbatch_size\033[0m = \033[0;33m[{batch_size}]\033[0m, \033[0;36mshuffle\033[0m = \033[0;33m[{shuffle}]\033[0m\n')
