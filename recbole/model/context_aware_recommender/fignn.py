...
class FiGNN(ContextRecommender):
    """ FiGNN is a CTR prediction model which uses Graph Neural Networks to model sophisticated
    feature interactions in a flexible and explicit fashion
    """
    ...
    def fignn_layer(self, infeature):
        ...
        for i in range(self.n_layers - 1):
            a = self.gnn(self.graph, att_infeature)
